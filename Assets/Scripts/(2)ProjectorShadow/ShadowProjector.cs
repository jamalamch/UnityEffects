...
public class ShadowProjector : MonoBehaviour 
{
    ...
    public float boundsOffset = 1;//Boundary offset,
    ...
    void LateUpdate()
    {
        //Seeking a shadow to generate an envelope box
        Bounds b = new Bounds();
...
#endif
        //Update the location of LightCamera and Projector, set parameters, and set parameters based on MainCamera
